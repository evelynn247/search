package com.biyao.search.bs.server.cache.redis;
...
public class RedisUtil {
	...
	public boolean set(String key, Object object, int seconds) {
		try {
            ...
            logger.error("redis set error, key is {},value is {},error message is {}",key,object,e);
            return false;
        }
        return true;
    }
	...
	public Object get(String key) throws JedisException {
		...
		try {
            ...
            logger.error("redis get object error, key is {},error message is {}",key,e);
		}
	...
	public Long ttl(String key) {
		try {
            ...
            logger.error("redis get ttl error, key is {},error message is {}",key,e);
            return null;
		}
	}
	...
	public Map<String, Object> hget(String key) {
		...
		try {
            ...
            logger.error("redis hget error, key is {},error message is {}",key,e);
		}
        return returnMap;
	}
	...
	public Object hget(String key, String field) {
		...
		try {
            ...
            logger.error("redis hget error, key is {},field is {},error message is {}",key,field,e);
		}
        return object;
	}
	...
	public String hgetString(String key, String field) {
		...
		try {
            ...
            logger.error("redis hgetString error, key is {},field is {},error message is {}",key,field,e);
		}
		return sRet;
	}
	...
	public boolean hset(String key, String field, Object value, int seconds) {
        ...
        try {
            ...
            logger.error("redis hset error, key is {},field is {},value is {} ,seconds is {} ,error message is {}", key, field, value ,seconds ,e);
        }
        return bRet;
    }
	/**
	...
	public boolean hdel(String key, String field) {
		...
		try {
            ...
            logger.error("redis hdel error, key is {},field is {},error message is {}", key, field ,e);
        }
        return bRet;
	}
	...
	public boolean hdelAll(String key) {
		...
		try {
            ...
            logger.error("redis hdelAll error, key is {},error message is {}", key, e);
        }
        return bRet;
	}
	...
	public boolean hexist(String key, String field) {
		...
		try {
            ...
            logger.error("redis hexist error, key is {},field is {} ,error message is {}", key,field, e);
		}
		return bRet;
	}
	...
	public byte[] gettobyte(String key) {
		...
		try {
            ...
            logger.error("redis gettobyte error, key is {},error message is {}", key , e);
		}
		return byteRet;
	}
	...
	public byte[] hgettobyte(String key, String field) {
		...
		try {
            ...
            logger.error("redis hgettobyte error, key is {},field is {} ,error message is {}", key,field, e);
        }
        return byteRet;
	}
	...
	public boolean settobyte(String key, byte[] value, int seconds) {
		...
		try {
            ...
            logger.error("redis settobyte error, key is {},value is {},error message is {}",key,new String(value),e);
        }
        return bRet;
	}
	...
	public boolean hsettobyte(String key, String field, byte[] value, int seconds) {
		...
		try {
            ...
            logger.error("redis hsettobyte error, key is {},field is {} ,value is {},error message is {}",key,field,new String(value),e);
		}
		return bRet;
	}
